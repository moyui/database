...
insert into 在泊船只 values('S07','小','C','P12');
...
insert into 时刻表 values('S01','A02','P01','2017-03-04',NULL);
insert into 时刻表 values('S02','A01','P03','2017-03-11',NULL);
insert into 时刻表 values('S02','A02','P03',NULL,'2017-03-20');
insert into 时刻表 values('S01','A01','P01',NULL,'2017-04-10');
insert into 时刻表 values('S05','A05','P11','2017-06-12',NULL);
insert into 时刻表 values('S04','A04','P07','2017-06-20',NULL);
insert into 时刻表 values('S03','A01','P04','2017-07-04',NULL);
insert into 时刻表 values('S06','A02','P01','2017-07-22',NULL);
insert into 时刻表 values('S07','A06','P12','2017-08-01',NULL);